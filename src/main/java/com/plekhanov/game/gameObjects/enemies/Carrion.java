...
public class Carrion extends Enemy {
    ...
    public Carrion(double x, double y, double speedX, double speedY, Model model) {
        super(x, y, speedX, speedY, ImageLoader.getImagesLevel_1().getEnemyCarrionImage(), IMAGE_WIDTH, IMAGE_HEIGHT, RENDER_ORDER, model);
    ...
    public BufferedImage getBufferedImage() {
        if (actionCount < Game.UPDATES / 2) {
            return ImageLoader.getImagesLevel_1().getHungryCarrion();
        }
